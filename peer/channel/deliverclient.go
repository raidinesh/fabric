...
//var logger = flogging.MustGetLogger("peer/channel")
...
func seekHelper(chainID string, start *ab.SeekPosition) *common.Envelope {
	...
	if err != nil {
		logger.Errorf("Error signing envelope %s\n", err)
		return nil
	}
	return env
}
...
func (r *deliverClient) readBlock() (*common.Block, error) {
	...
	if err != nil {
		logger.Errorf("Error receiving: %s\n", err)
